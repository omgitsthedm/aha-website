...
- **Storefront navigation** is Shop · Tees · Hoods & Crews · Manifesto · About · Track order. The gender routes (`/men`, `/women`, `/unisex`) and empty categories (`/accessories`, `/new-arrivals`, sweaters) still resolve but are unlinked and out of the sitemap; the shop hides search, size, sort and index chrome while the catalog holds twelve pieces or fewer.
