...
export const metadata = buildMetadata({ title: "Track Your Order", description: "Check an After Hours Agenda order using its confirmation number and checkout email.", path: "/track-order" });
