...
const sections = [
  ...
  ["Shipping and returns", "Current production, shipping, and return terms are described on the Shipping and Returns pages. Made-to-order production costs may be non-refundable after printing begins. Confirmed defects, damage, and incorrect items are reviewed separately."],
