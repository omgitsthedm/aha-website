...
export default function ShippingPage() {
  return (
    <div className="px-4 pb-20 pt-28 md:px-6 md:pt-32"><div className="mx-auto max-w-4xl">
      <PageHeader eyebrow="Made-to-order timeline" title="From the press to your door" description="Standard shipping is included on every US order. Canada, the UK, and Australia ship at a $20 flat rate per order. Production happens first; carrier transit starts after the piece clears production." />
      <dl className="border-t border-border/40">
        <div className="grid gap-3 border-b border-border/40 py-7 md:grid-cols-[12rem_1fr]"><dt className="font-display text-xl font-bold uppercase">Order total</dt><dd className="text-sm leading-relaxed text-muted">The final item total, the shipping line, and estimated tax appear before Square processes payment. US orders ship free; Canada, the UK, and Australia add a $20 flat rate per order. The checkout email becomes the order contact.</dd></div>
