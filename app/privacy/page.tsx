...
const sections = [
  ...
  ["Service providers (sub-processors)", "Information is shared only as needed for site operation and existing-order support. This can include Square for prior payments, Printful for prior fulfillment, Netlify for hosting, Neon for the operational database, and Resend for email. With your consent, analytics and advertising providers may also process data as described below. Provider privacy terms apply."],
