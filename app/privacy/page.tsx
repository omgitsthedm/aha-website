...
export const metadata = buildMetadata({ title: "Storefront Privacy Policy", description: "What After Hours Agenda collects for checkout and support, how Square and Printful process order data, and how to request access or deletion.", path: "/privacy" });
...
const sections = [
  ...
  ["Global Privacy Control", "If your browser sends a Global Privacy Control signal, the storefront treats it as an opt-out. Optional analytics and advertising remain off while that signal is active, even if a prior stored choice allowed them."],
