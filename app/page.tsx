  ...
  return (
    <div className="pb-20 lg:pb-28">
      ...
      <section aria-labelledby="collection-heading" className="mx-auto mt-24 max-w-[1320px] px-5 sm:px-8 lg:mt-32">
        ...
        {products.length > 0 ? (
          <ul className="grid grid-cols-2 gap-x-4 gap-y-10 md:grid-cols-4 md:gap-x-6" data-testid="home-collection-grid">
        ...
        <div className="mt-8 md:hidden">
          <Link href="/shop" className="btn-primary w-full justify-center">See all</Link>
        </div>
      </section>

      {/* The story. The after-hours character is the maker — never a niche. */}
      <section aria-labelledby="story-heading" className="mx-auto mt-28 max-w-[1320px] px-5 sm:px-8 lg:mt-36">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20">
          <div className="frame relative aspect-[4/3] overflow-hidden bg-charcoal">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6">
              ...
              <Link href="/manifesto" className="font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-cream underline decoration-border underline-offset-8 hover:decoration-cream">Manifesto</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <section aria-labelledby="lookbook-heading" className="mx-auto mt-28 max-w-[1320px] px-5 sm:px-8 lg:mt-36">
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-6">
            {lookbookTeaser.map((shot) => (
              <Link key={shot.src} href={shot.productSlug ? `/product/${shot.productSlug}` : "/lookbook"} className="frame image-hover-zoom relative block aspect-[4/5] overflow-hidden">
      ...
      <section aria-labelledby="statement-heading" className="mx-auto mt-28 max-w-[1320px] px-5 sm:px-8 lg:mt-36">
        <div className="grid items-center gap-12 lg:grid-cols-[0.7fr_1.3fr]">
          <div className="neon-sign m-scale flex items-center justify-center">
            <div className="neon-flicker flex w-full max-w-[340px] flex-col items-center">
