  ...
  return (
    <div className="px-4 pb-20 pt-28 md:px-6 md:pt-32"><div className="mx-auto max-w-4xl">
      ...
      <div className="grid gap-px border border-border/40 bg-border/40 md:grid-cols-3">
        <section className="bg-void p-6"><p className="text-xs font-bold uppercase tracking-[0.08em] text-accent">01 / Contact</p><h2 className="mt-3 font-display text-xl font-black uppercase">Start with the order</h2><p className="mt-3 text-sm leading-relaxed text-muted">Email {SUPPORT_EMAIL} within {RETURNS_WINDOW} of delivery. Include the order number, item, and reason for the request.</p></section>
        <section className="bg-void p-6"><p className="text-xs font-bold uppercase tracking-[0.08em] text-accent">02 / Review</p><h2 className="mt-3 font-display text-xl font-black uppercase">Keep it unworn</h2><p className="mt-3 text-sm leading-relaxed text-muted">Change-of-mind returns must be unworn, unwashed, and in original condition. Wait for return instructions before sending anything.</p></section>
        <section className="bg-void p-6"><p className="text-xs font-bold uppercase tracking-[0.08em] text-accent">03 / Resolution</p><h2 className="mt-3 font-display text-xl font-black uppercase">We inspect, then resolve</h2><p className="mt-3 text-sm leading-relaxed text-muted">Eligible returns are inspected before refund approval. Original made-to-order production costs may be non-refundable once printing begins.</p></section>
      </div>
