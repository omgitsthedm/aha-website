export function AnnouncementBar() {
  return (
    <aside aria-label="Store announcement" className="fixed inset-x-0 top-0 z-[110] flex h-8 items-center justify-center border-b border-accent bg-rose text-cream">
